  ...
  return (
    <main className="bg-[#013B94]">
      <section className=" max-w-7xl mx-auto p-6">
        <h2 className=" font-bold text-5xl text-white">Find your Stay</h2>
      ...
      <section className=" mx-auto max-w-7xl mt-10 p-6 bg-white rounded-lg">
        <div className=" pt-5">
          ...
          <p className=" font-light">
            Most popular choices for travellers from around the word
          </p>
        </div>
        <div className=" flex space-x-4 py-5 overflow-x-scroll">
          {trending_data.map((item) => (
            <div className=" space-y-1 shrink-0 cursor-pointer" key={item.id}>
              <img
                key={item.id}
